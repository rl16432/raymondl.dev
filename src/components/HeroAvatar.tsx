...
const HeroAvatar = (props: IHeroAvatarProps) => (
  <div className="flex flex-col items-center gap-y-10 md:flex-row md:justify-between md:gap-x-16 md:gap-y-0">
    <div>
      <h1 className="text-3xl font-bold">{props.title}</h1>

      <p className="mt-6 text-xl leading-9">{props.description}</p>

      <div className="mt-3 flex gap-3">{props.socialButtons}</div>
    </div>
